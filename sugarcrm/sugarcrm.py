...
class Sugarcrm:
    ...
    def __init__(self, url, username, password, application='', name_value_list={'language': {'name': 'language', 'value': 'en_us'}, 'notifyonsave': {'name': 'notifyonsave', 'value': False}}, is_ldap_member=False):
        ...
        self._name_value_list = name_value_list
    ...
    def _sendRequest(self, method, data):
        ...
        # Added method != 'logout' because logout method in sugarcrm does not return anything
        if is_error(result):
    ...
    def _login(self):
        ...
        user_auth = {}
        user_auth['user_name'] = self._username
        user_auth['password'] = self.password
        application = self._application
        name_value_list = self._name_value_list
        args = [user_auth, application, name_value_list]
        print args
